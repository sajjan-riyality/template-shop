                            ...
                            <li class="dropdown-show"><a href="single-product.php">products</a>
                                <ul class="mega-menu-wrap dropdown-nav">
                                    <li class="mega-menu-item"><a href="single-product.php"
                                        ...
                                        <ul>
                                            <li><a href="single-product.php">traditional nekless</a></li>
                                            <li><a href="single-product.php">western nekless</a></li>
                                            <li><a href="single-product.php">traditional mangalsutra</a></li>
                                            <li><a href="single-product.php">vestern mangalsutra</a></li>
                                            <li><a href="single-product.php">moti set </a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="mega-menu-item"><a href="shop-left-full-wide.html"
                                        ...
                                        <ul>
                                            <li><a href="single-product.php">haldi set</a></li>
                                            <li><a href="single-product.php">hear acceseries</a></li>
                                            <li><a href="single-product.php">watch</a></li>
                                            <li><a href="single-product.php">hand cluch </a></li>
