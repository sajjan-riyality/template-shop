            ...
            <div class="col-12 text-center">
                <div class="page-title-content">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="login-register.html" class="active">About Us</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="about-image-wrap">
                    <a href="about.html">
                        <img src="assets/img/about-img.png" alt="About Us" class="img-fluid"/>
                    </a>
                </div>
            ...
            <div class="col-lg-6 m-auto">
                ...
                <div class="about-content-wrap ms-0 ms-lg-5 mt-5 mt-lg-0">
                    <h2>About Us</h2>
