...
<head>
    ...
    <title>Checkout :: Roopdershani Alankar </title>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="checkoutaccordion" id="checkOutAccordion">
                    <div class="card">
                        <h3>Returning Customer? <span data-bs-toggle="collapse" data-bs-target="#logInaccordion">Click Here To Login</span>
                        </h3>
                                ...
                                <div class="login-reg-form-wrap">
                                    <form action="#" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="single-input-item">
                                                    <button class="btn-login mt-0">Login</button>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card">
                        <h3>Have A Coupon? <span data-bs-toggle="collapse" data-bs-target="#couponaccordion">Click Here To Enter Your Code</span>
                        </h3>
                    ...
                    <div class="billing-form-wrap">
                        <form action="#">
                            ...
                            <div class="checkout-box-wrap">
                                <div class="single-input-item">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="ship_to_different">
                                        <label class="form-check-label" for="ship_to_different">Ship to a different
                                            address?</label>
                                    </div>
                                </div>
                                        ...
                                        <ul class="shipping-type">
                                            <li>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="flatrate">Flat Rate:
                                                        $70.00</label>
                                                </div>
                                            </li>
                                            <li>
                        ...
                        <div class="order-payment-method">
                                ...
                                <div class="payment-method-name">
                                    <div class="form-check">
                                        <input type="radio" id="cashon" name="paymentmethod" value="cash"
                                               class="form-check-input" checked/>
                                        <label class="form-check-label" for="cashon">Cash On Delivery</label>
                                    </div>
                                </div>
                                ...
                                <div class="payment-method-name">
                                    <div class="form-check">
                                        <input type="radio" id="directbank" name="paymentmethod" value="bank"
                                               class="form-check-input"/>
                                        <label class="form-check-label" for="directbank">Direct Bank Transfer</label>
                                    </div>
                                </div>
                                ...
                                <div class="payment-method-name">
                                    <div class="form-check">
                                        <input type="radio" id="checkpayment" name="paymentmethod" value="check"
                                               class="form-check-input"/>
                                        <label class="form-check-label" for="checkpayment">Pay with Check</label>
                                    </div>
                                </div>
                                ...
                                <div class="payment-method-name">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="paypalpayment">
                                            Paypal <img src="assets/img/paypal-card.jpg" class="img-fluid paypal-card"
                                                        alt="Paypal"/>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="summary-footer-area">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms">I have read and agree to the website
